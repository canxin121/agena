pub(in crate::app) fn permission_rule_params_from_draft(
...
pub(in crate::app) fn parse_permission_mode_token(
    i18n: &I18n,
    token: &str,
...
pub(in crate::app) fn parse_pr_command_args(
    args: &str,
...
pub(in crate::app) fn split_command_args_once(value: &str) -> Option<(&str, &str)> {
...
pub(in crate::app) fn slash_command_suggestion_context_for_text(
    text: &str,
    cursor: usize,
