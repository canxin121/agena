impl App {
    pub(in crate::app) fn session_model_chooser_items(
        &self,
    ) -> UiResult<Vec<SessionModelChoiceItem>> {
    ...
    pub(in crate::app) fn request_provider_studio_save_draft(
        &mut self,
    ...
    pub(in crate::app) fn request_provider_studio_save_selected_adapter(
        &mut self,
        dialog: ProviderStudioOverlay,
    ) {
    ...
    pub(in crate::app) fn request_provider_studio_delete_model(
        &mut self,
        draft: ProviderConfigDraft,
        adapter_id: String,
        model_id: String,
    ...
    pub(in crate::app) fn request_provider_studio_delete_provider(&mut self, provider_id: String) {
        let backend = self.backend.clone();
        let tx = self.tx.clone();
        tokio::spawn(async move {
    ...
    pub(in crate::app) fn request_provider_studio_delete_adapter(
        &mut self,
        draft: ProviderConfigDraft,
        adapter_id: String,
    ) {
    ...
    pub(in crate::app) fn move_provider_studio_selection(
        &mut self,
    ...
    pub(in crate::app) fn move_provider_studio_selection_page(
        &mut self,
        dialog: &mut ProviderStudioOverlay,
        delta: isize,
        page_size: usize,
    ...
    pub(in crate::app) fn move_provider_studio_selection_home(
        &mut self,
        dialog: &mut ProviderStudioOverlay,
    ) {
        match dialog.selection.focus() {
    ...
    pub(in crate::app) fn move_provider_studio_selection_end(
        &mut self,
        dialog: &mut ProviderStudioOverlay,
    ) {
        match dialog.selection.focus() {
    ...
    pub(in crate::app) fn open_provider_studio_detail_page(
        &mut self,
        dialog: &mut ProviderStudioOverlay,
    ) {
    ...
    pub(in crate::app) fn guide_provider_studio_auth_field(
        &mut self,
        dialog: &mut ProviderStudioOverlay,
    ...
    pub(in crate::app) fn activate_provider_studio_start_auth(
        &mut self,
        dialog: &mut ProviderStudioOverlay,
    ) {
    ...
    pub(in crate::app) fn activate_provider_studio_continue_auth(
        &mut self,
        dialog: &mut ProviderStudioOverlay,
    ) {
    ...
    pub(in crate::app) fn activate_provider_studio_field_editor(
        &mut self,
        dialog: &mut ProviderStudioOverlay,
        field: ProviderStudioField,
    ) {
    ...
    pub(in crate::app) fn activate_provider_studio_detail_page_selection(
        &mut self,
        dialog: &mut ProviderStudioOverlay,
    ) {
    ...
    pub(in crate::app) fn handle_provider_studio_detail_page_key(
        &mut self,
        key: KeyEvent,
        dialog: &mut ProviderStudioOverlay,
    ) -> bool {
    ...
    pub(in crate::app) fn open_provider_studio_model_page(
        &mut self,
        dialog: &mut ProviderStudioOverlay,
        adapter_id: String,
        model_id: String,
    ...
    pub(in crate::app) fn open_provider_studio_new_model_editor(
        &mut self,
        dialog: &mut ProviderStudioOverlay,
    ) {
    ...
    pub(in crate::app) fn open_provider_studio_delete_provider_confirm(
        &mut self,
        provider_id: String,
    ) {
    ...
    pub(in crate::app) fn open_provider_studio_delete_model_confirm(
        &mut self,
        dialog: &ProviderStudioOverlay,
        adapter_id: String,
        model_id: String,
    ...
    pub(in crate::app) fn open_provider_studio_delete_selected_adapter_confirm(
        &mut self,
        dialog: &mut ProviderStudioOverlay,
    ) {
        let Some(adapter_id) = provider_studio_selected_adapter_id(dialog) else {
    ...
    pub(in crate::app) fn open_provider_studio_delete_selected_model_confirm(
        &mut self,
        dialog: &mut ProviderStudioOverlay,
    ) {
