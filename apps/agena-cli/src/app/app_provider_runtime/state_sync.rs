impl App {
    pub(in crate::app) fn sync_provider_studio_shape(
        &mut self,
    ...
    pub(in crate::app) fn sync_provider_studio_auth_poll_deadline(
        &self,
        dialog: &mut ProviderStudioOverlay,
        now: Instant,
        reset: bool,
    ...
    pub(in crate::app) fn reload_provider_studio_catalog_matches(
        &self,
        dialog: &mut ProviderStudioOverlay,
    ) {
    ...
    pub(in crate::app) fn refresh_provider_studio_adapter_state(
        &mut self,
        dialog: &mut ProviderStudioOverlay,
    ) {
