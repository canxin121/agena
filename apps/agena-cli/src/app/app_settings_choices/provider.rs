impl App {
    pub(in crate::app) fn current_provider_default_model_ref(&self) -> Option<ModelRef> {
    ...
    pub(in crate::app) fn apply_provider_default_model(&mut self, model: ModelRef) -> bool {
    ...
    pub(in crate::app) fn persist_provider_default_model(&self, model: &ModelRef) -> UiResult<()> {
    ...
    pub(in crate::app) fn provider_default_model_mode_choice_items(
        &self,
        model: &ModelRef,
    ...
    pub(in crate::app) fn open_provider_default_model_mode_step_or_next(
        &mut self,
        model: ModelRef,
        step: SessionModelModeStep,
    ) {
    ...
    pub(in crate::app) fn advance_provider_default_model_mode_step(
        &mut self,
        model: ModelRef,
        step: SessionModelModeStep,
    ) {
    ...
    pub(in crate::app) fn persist_provider_default_model_mode(
        &self,
        model: &ModelRef,
        step: SessionModelModeStep,
        value: &str,
...
use crate::app::{
    App, ChoiceItem, ChoiceOverlayAction, ChoiceOverlayStyle, JsonMap, JsonValue, ModelRef,
    SessionModelModeStep, UiResult, choice_item, choice_item_with_value, get_json_path,
