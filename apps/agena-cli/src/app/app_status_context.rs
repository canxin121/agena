...
impl App {
    ...
    pub(in crate::app) fn current_runtime_status_summary(&self) -> String {
        let mut parts = vec![
            self.run_options
                .summary(&self.i18n)
    ...
    pub(in crate::app) fn workspace_context_label(&self) -> String {
        self.i18n.text_args(
    ...
    pub(in crate::app) fn current_execution_context_parts(
        &self,
