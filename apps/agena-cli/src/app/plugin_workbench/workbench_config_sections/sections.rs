...
pub(in crate::app) fn plugin_semantic_diagnostics(
...
pub(in crate::app) fn build_config_sections(
    plugin: &PluginWorkbenchPlugin,
...
pub(in crate::app) fn build_web_config_sections(
    plugin: &PluginWorkbenchPlugin,
) -> Vec<ConfigSectionView> {
...
pub(in crate::app) fn build_generic_config_sections(
    plugin: &PluginWorkbenchPlugin,
) -> Vec<ConfigSectionView> {
