...
pub(in crate::app) fn append_schema_editor_lines(
...
pub(in crate::app) fn append_branch_selector_lines(
    lines: &mut Vec<Line<'static>>,
...
pub(in crate::app) fn append_type_selector_line(
    lines: &mut Vec<Line<'static>>,
    schema: &JsonValue,
    value: &JsonValue,
    depth: usize,
...
pub(in crate::app) fn append_object_editor_lines(
    lines: &mut Vec<Line<'static>>,
    root_schema: Option<&JsonValue>,
    schema: Option<&JsonValue>,
...
pub(in crate::app) fn append_object_array_table(
    lines: &mut Vec<Line<'static>>,
    root_schema: Option<&JsonValue>,
    schema: Option<&JsonValue>,
    items: &[JsonValue],
...
pub(in crate::app) fn append_string_editor_lines(
    lines: &mut Vec<Line<'static>>,
    schema: Option<&JsonValue>,
    title: &str,
    text: &str,
...
pub(in crate::app) fn append_number_editor_lines(
    lines: &mut Vec<Line<'static>>,
    schema: Option<&JsonValue>,
    title: &str,
    number: &JsonNumber,
...
pub(in crate::app) fn append_null_editor_lines(
    lines: &mut Vec<Line<'static>>,
    schema: Option<&JsonValue>,
    title: &str,
    depth: usize,
