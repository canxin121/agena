...
pub(in crate::app) fn provider_studio_start_auth_summary(
    i18n: &I18n,
...
pub(in crate::app) fn provider_studio_continue_auth_summary(
    i18n: &I18n,
    dialog: &ProviderStudioOverlay,
) -> String {
    match dialog.draft.auth_kind.credential_issuer() {
...
pub(in crate::app) fn provider_studio_secret_source_hint(
    i18n: &I18n,
    draft: &ProviderConfigDraft,
) -> Option<String> {
...
pub(in crate::app) fn provider_studio_auth_details_summary(
    i18n: &I18n,
    dialog: &ProviderStudioOverlay,
) -> String {
