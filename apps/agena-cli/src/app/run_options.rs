...
impl RunOptionsState {
    pub(super) fn clear_model_stack(&mut self) {
        self.model = None;
    ...
    pub(super) fn runtime_setting_summary(&self, i18n: &I18n, field: RuntimeSettingSpec) -> String {
        match field.id {
    ...
    pub(super) fn runtime_setting_input_text(&self, field: RuntimeSettingSpec) -> String {
        match field.id {
    ...
    pub(super) fn apply_runtime_setting_input(
        &mut self,
        i18n: &I18n,
    ...
    pub(super) fn to_request(&self) -> RunOptions {
        RunOptions {
    ...
    pub(super) fn summary(&self, i18n: &I18n) -> Option<String> {
