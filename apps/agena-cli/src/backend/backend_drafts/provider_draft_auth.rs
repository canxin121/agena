...
pub(crate) const CLINE_API_OPENAI_PROTOCOL_PATH: &str = "/api/v1";
pub(crate) const CLINE_API_MODELS_URL: &str =
    "https://api.cline.bot/api/v1/ai/cline/recommended-models";

pub(crate) fn cline_api_protocol_paths() -> agena::config::ProviderProtocolPathsConfig {
...
pub(crate) fn draft_secret_source_value(source: Option<&ProviderSecretSourceConfig>) -> String {
    match source {
...
use crate::backend::{
    CredentialIssuer, ProviderConfigDraft, ProviderSecretSourceConfig, anyhow,
    credential_issuer_label, parse_credential_issuer,
};
