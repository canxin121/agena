...
overlay-permission-rules-footer = Enter edit | n new | d delete | Esc close
...
overlay-permission-rule-delete-title = Delete Permission Rule
overlay-permission-rule-delete-body = Remove persisted rule {$name}?
...
flash-permission-rule-deleted = deleted permission rule: {$name}
