...
status-global = Alt+S sessions | Alt+P commands | ? help | q/Ctrl+C quit
status-sessions = Sessions: Alt+S switcher | /sessions [query] | /search [query]
...
help-sessions-line-3 = /sessions or /search opens the switcher; arguments prefill its filter
...
help-actions-line-1 = n create session, s or Alt+S opens the resume picker, b opens branch history, [ opens parent session, ] opens child sessions, P opens plugin inspector
...
overlay-provider-studio-footer = Tab focus | Enter edit/select | Space toggle adapter | / search catalog | r list models | R refresh catalog | s save provider | a save adapter models | m save selected model | Esc close
overlay-provider-studio-search-title = Catalog Search
overlay-provider-studio-search-prompt = Filter the model catalog by id, display name, origin, or description
...
flash-provider-studio-model-required = select a catalog entry or listed model first
