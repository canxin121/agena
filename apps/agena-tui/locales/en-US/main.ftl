...
status-composer = Composer: Enter queue/send | Ctrl+Enter send now | Alt+Up/Down history | Shift+Enter newline | / commands | Tab chat
...
help-composer-line-10 = Alt+Up/Down recalls sent prompts; Alt+P opens the command palette, and slash commands like /model, /fork, or /rewind run from the composer
