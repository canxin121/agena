...
no-session-selected-hint = Use el panel de sesiones o empiece a escribir en el editor para crear una.
composer-session-new = nueva sesion
composer-placeholder = Enter envia. F3 adjunta archivo. Alt/Shift+Enter o Ctrl+J inserta salto de linea. F4 edicion externa. F6 imagen del portapapeles.

status-sessions = Tab cambia de panel | / busca sesiones | Enter abre | n nueva sesion | q salir
status-transcript = Tab cambia de panel | / o Ctrl+F busca | y copia la transcripcion | Y copia la vista | q salir
status-composer = Enter envia | F3 adjunta | F4 edita | F6 imagen | Tab cambia de panel | q salir

help-title = Ayuda
help-header = Agena TUI
help-section-sessions = Panel de sesiones
help-sessions-line-1 = Up/Down, PageUp/PageDown mueven la seleccion
help-sessions-line-2 = Enter abre la sesion seleccionada
help-sessions-line-3 = / abre la busqueda de sesiones del backend
help-section-transcript = Panel de transcripcion
help-transcript-line-1 = j/k o flechas desplazan
help-transcript-line-2 = Space / Shift+Space / Ctrl+F / Ctrl+B paginan
help-transcript-line-3 = Ctrl+D / Ctrl+U media pagina
help-transcript-line-4 = PageUp o desplazarse cerca del borde superior carga mensajes anteriores
help-transcript-line-5 = g/G salta al inicio o al final
help-transcript-line-6 = / o Ctrl+F busca en la transcripcion cargada, n/N cambian de coincidencia
help-transcript-line-7 = y copia la transcripcion cargada, Y copia la vista visible
help-section-composer = Editor
help-composer-line-1 = Enter envia
...
help-composer-line-9 = Pegar una sola ruta de archivo la adjunta; los pegados grandes se convierten en marcadores en linea y los adjuntos permanecen atomicos
...
help-actions-line-4 = u abre la primera solicitud de entrada de usuario pendiente
help-actions-line-5 = La captura del raton esta desactivada para conservar la seleccion y copia nativas del terminal
help-actions-line-6 = q o Ctrl+C salen
...
message-tool-pending = herramienta pendiente: {$label}
message-tool-running = herramienta en ejecucion: {$label}
message-tool-done = herramienta terminada: {$label}
message-tool-failed = herramienta fallida: {$label}
