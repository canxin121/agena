...
help-section-sessions = Panneau des sessions
help-sessions-line-1 = Up/Down, PageUp/PageDown deplacent la selection
help-sessions-line-2 = Enter ouvre la session selectionnee
help-sessions-line-3 = / ouvre la recherche de sessions backend
help-section-transcript = Panneau du transcript
help-transcript-line-1 = j/k ou les fleches font defiler
help-transcript-line-2 = Space / Shift+Space / Ctrl+F / Ctrl+B paginent
help-transcript-line-3 = Ctrl+D / Ctrl+U demi-page
help-transcript-line-4 = PageUp ou le defilement pres du haut charge les anciens messages
help-transcript-line-5 = g/G saute au debut ou a la fin
help-transcript-line-6 = / ou Ctrl+F recherche le transcript charge, n/N deplacent le resultat actif
help-transcript-line-7 = y copie le transcript charge, Y copie la zone visible
help-section-composer = Zone de composition
help-composer-line-1 = Enter envoie
help-composer-line-2 = Alt/Shift+Enter ou Ctrl+J insere une nouvelle ligne
help-composer-line-3 = Ctrl+A/E/B/F/P/N se deplacent, Alt+B/F ou Alt/Ctrl+Left/Right sautent par mot
...
help-composer-line-6 = F3, Ctrl+O ou Alt+O recherchent des fichiers du workspace a joindre
...
help-composer-line-9 = Coller un chemin unique joint le fichier; les gros collages deviennent des espaces reserves en ligne et les pieces jointes restent atomiques
help-section-actions = Actions
help-actions-line-1 = n cree une session
help-actions-line-2 = r continue une session bloquee ou en attente
help-actions-line-3 = a/A/d/D repondent a la premiere demande d'autorisation en attente
help-actions-line-4 = u ouvre la premiere demande d'entree utilisateur en attente
help-actions-line-5 = La capture de souris est desactivee pour conserver la selection/copie du terminal
help-actions-line-6 = q ou Ctrl+C quitte
