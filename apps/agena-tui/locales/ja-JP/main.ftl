...
help-section-sessions = セッションペイン
help-sessions-line-1 = Up/Down、PageUp/PageDown で選択移動
help-sessions-line-2 = Enter で選択したセッションを開く
help-sessions-line-3 = / でバックエンドのセッション検索を開く
...
help-transcript-line-4 = PageUp または上端付近でのスクロールで古いメッセージを読み込む
help-transcript-line-5 = g/G で先頭または末尾へ移動
help-transcript-line-6 = / または Ctrl+F で読み込み済み内容を検索し、n/N で結果を移動
help-transcript-line-7 = y で全文コピー、Y で表示範囲をコピー
