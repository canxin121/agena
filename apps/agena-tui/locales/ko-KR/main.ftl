...
help-section-sessions = 세션 창
help-sessions-line-1 = Up/Down, PageUp/PageDown 으로 선택 이동
help-sessions-line-2 = Enter 로 선택한 세션 열기
help-sessions-line-3 = / 로 백엔드 세션 검색 열기
help-section-transcript = 대화 기록 창
help-transcript-line-1 = j/k 또는 화살표로 스크롤
help-transcript-line-2 = Space / Shift+Space / Ctrl+F / Ctrl+B 페이지 이동
help-transcript-line-3 = Ctrl+D / Ctrl+U 반 페이지 이동
help-transcript-line-4 = PageUp 또는 상단 근처 스크롤로 이전 메시지 로드
help-transcript-line-5 = g/G 로 맨 위 또는 맨 아래 이동
help-transcript-line-6 = / 또는 Ctrl+F 로 로드된 기록 검색, n/N 으로 결과 이동
help-transcript-line-7 = y 전체 복사, Y 보이는 영역 복사
help-section-composer = 입력창
help-composer-line-1 = Enter 전송
...
help-composer-line-9 = 단일 파일 경로 붙여넣기는 바로 첨부되고, 큰 붙여넣기는 인라인 플레이스홀더가 되며, 첨부는 원자적으로 유지됩니다
...
help-actions-line-4 = u 로 첫 번째 사용자 입력 요청 열기
help-actions-line-5 = 마우스 캡처가 꺼져 있어 터미널 기본 선택/복사가 그대로 동작합니다
help-actions-line-6 = q 또는 Ctrl+C 종료
