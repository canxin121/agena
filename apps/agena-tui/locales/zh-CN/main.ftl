...
overlay-permission-rules-footer = Enter 编辑 | n 新建 | d 删除 | Esc 关闭
...
overlay-permission-rule-delete-title = 删除权限规则
overlay-permission-rule-delete-body = 删除持久化规则 {$name}？
...
flash-permission-rule-deleted = 权限规则已删除：{$name}
