...
pub(in crate::app) fn provider_list_create_item(
    i18n: &I18n,
) -> (
...
pub(in crate::app) fn provider_model_catalog_lookup_id(model: &ProviderModelResource) -> String {
    model
        .catalog_model_id
        .as_ref()
        .cloned()
...
mod tests {
    ...
    use crate::app::{ModelRef, ProviderModel, SessionModelIdentity};
