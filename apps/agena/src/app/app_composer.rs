impl App {
    ...
    pub(in crate::app) fn complete_file_mention_suggestion(&mut self, key: String) {
    ...
    pub(in crate::app) fn complete_slash_command_suggestion(&mut self, key: String, submit: bool) {
        let Some(action) = self
    ...
    pub(in crate::app) fn apply_slash_command_completion(
        &mut self,
        action: &SlashCommandSuggestionAction,
    ) {
            ...
            .filter(|entry| plugin_command_matches_slash_query(entry, &query))
        {
            ...
            actions.insert(
                ...
                SlashCommandSuggestionAction {
                    ...
                    can_submit_without_arguments: false,
                },
            );
            items.push(SlashCommandSuggestionItem {
                key,
