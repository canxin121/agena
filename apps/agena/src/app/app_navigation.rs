impl App {
    ...
    pub(in crate::app) fn lineage_session_navigation_item(
        &self,
    ...
    pub(in crate::app) fn rewind_message_navigation_item(
        &self,
        session_id: i64,
    ...
    pub(in crate::app) fn prepare_composer_command(&mut self, command_name: &str) {
        ...
        match self.block_on_async(
            ...
            Ok(execution) => {
                ...
                self.flash_success(self.i18n.text_args(
                    ...
                    &agena_tui::fl_args!("agent" => agent_name),
                ));
                true
            }
            Err(error) => {
