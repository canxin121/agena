...
impl App {
    ...
    pub(in crate::app) fn take_selection_picker_route(&mut self) -> Option<SelectionPickerOverlay> {
    ...
    pub(in crate::app) fn restore_selection_picker_route(
        &mut self,
        dialog: SelectionPickerOverlay,
    ) {
        self.current_route = Route::SelectionPicker(dialog);
    }

    pub(in crate::app) fn take_session_navigation_route(
        &mut self,
    ) -> Option<SessionNavigationOverlay> {
        match std::mem::replace(&mut self.current_route, Route::Main) {
    ...
    pub(in crate::app) fn restore_session_navigation_route(
        &mut self,
        dialog: SessionNavigationOverlay,
    ) {
    ...
    pub(in crate::app) fn open_choice_overlay(&mut self, dialog: ChoiceOverlay) {
