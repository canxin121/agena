...
pub(in crate::app) fn agent_default_summary(i18n: &I18n, default: &AgentSelectionConfig) -> String {
...
pub(in crate::app) fn agent_permission_summary(
    i18n: &I18n,
...
pub(in crate::app) fn settings_studio_agent_browser_item(
    i18n: &I18n,
    agent_count: usize,
...
pub(in crate::app) fn permission_layer_source_rows(
    i18n: &I18n,
...
pub(in crate::app) fn settings_studio_permission_items(
    i18n: &I18n,
    sources: &ConfigJsonSources,
    global_permission: &PermissionConfig,
    workspace_permission: &PermissionConfig,
...
pub(in crate::app) fn agent_picker_item(
    i18n: &I18n,
...
pub(in crate::app) fn agent_descriptor_storage(
    agent: &AgentDescriptor,
    config_owned: bool,
) -> AgentProfileStorage {
...
pub(in crate::app) fn agent_scope_label_localized(i18n: &I18n, scope: AgentScope) -> String {
    ui_text::t(
        i18n,
        match scope {
...
pub(in crate::app) fn agent_list_create_item(
    i18n: &I18n,
) -> (
    agena_tui::selection_picker::SelectionPickerItem,
    SelectionPickerCommand,
...
pub(in crate::app) fn agent_list_items(
    i18n: &I18n,
...
pub(in crate::app) fn agent_profile_storage_label_localized(
    i18n: &I18n,
...
pub(in crate::app) fn agent_profile_scope_label_localized(
    i18n: &I18n,
    profile: &AgentProfile,
) -> String {
    ui_text::t(
...
pub(in crate::app) fn agent_profile_source_label_localized(
    i18n: &I18n,
    profile: &AgentProfile,
    storage: AgentProfileStorage,
) -> String {
...
pub(in crate::app) fn agent_prompt_summary(i18n: &I18n, prompt: &str) -> String {
...
pub(in crate::app) fn agent_optional_string_summary(
    i18n: &I18n,
    value: Option<&str>,
    empty_key: &str,
) -> String {
...
pub(in crate::app) fn agent_studio_items(
    i18n: &I18n,
    profile: &AgentProfile,
    storage: AgentProfileStorage,
...
pub(in crate::app) fn agent_studio_item_detail_text(
    i18n: &I18n,
    profile: &AgentProfile,
...
pub(in crate::app) fn agent_studio_overview_text(
    i18n: &I18n,
    profile: &AgentProfile,
...
mod tests {
    ...
    use crate::app::{AgentDescriptor, AgentScope, HashSet, I18n, SelectionPickerCommand};
