pub(in crate::app) fn recompute_plugin_config_state(plugin: &mut PluginWorkbenchPlugin) {
...
pub(in crate::app) fn plugin_config_error_count(plugin: &PluginWorkbenchPlugin) -> usize {
    plugin
        .diagnostics
        .iter()
...
pub(in crate::app) fn plugin_save_block_reason(plugin: &PluginWorkbenchPlugin) -> Option<String> {
...
pub(in crate::app) fn config_status_for_plugin(
...
pub(in crate::app) fn normalize_override_value(value: JsonValue) -> JsonValue {
    match value {
...
pub(in crate::app) fn persisted_plugin_config_value(plugin: &PluginWorkbenchPlugin) -> JsonValue {
    normalize_override_value(plugin.draft_override.clone())
}

pub(in crate::app) fn derive_override_value(
    default: &JsonValue,
    effective: &JsonValue,
) -> JsonValue {
...
pub(in crate::app) fn derive_override_option(
    default: &JsonValue,
    effective: &JsonValue,
) -> Option<JsonValue> {
...
pub(in crate::app) fn row_paths(row: &ConfigRowView) -> Vec<&ConfigPath> {
    std::iter::once(&row.primary_path)
        .chain(row.additional_paths.iter())
        .collect()
}

pub(in crate::app) fn reset_effective_value_at_path(
    value: &mut JsonValue,
...
pub(in crate::app) fn path_present_in_value(value: &JsonValue, path: &[PathSegment]) -> bool {
...
pub(in crate::app) fn path_is_prefix_of(prefix: &[PathSegment], path: &[PathSegment]) -> bool {
    prefix.len() <= path.len()
        && prefix
            .iter()
            .zip(path.iter())
...
pub(in crate::app) fn section_row_count(
...
pub(in crate::app) fn section_row_at(
    section: &ConfigSectionView,
    view: PluginConfigView,
    index: usize,
...
pub(in crate::app) fn find_row_position(
    plugin: &PluginWorkbenchPlugin,
    view: PluginConfigView,
    path: &[PathSegment],
) -> Option<(usize, usize)> {
...
pub(in crate::app) fn find_best_section_row_for_path(
    plugin: &PluginWorkbenchPlugin,
    view: PluginConfigView,
...
pub(in crate::app) fn find_best_drilldown_row_for_path(
...
pub(in crate::app) fn row_best_path_prefix_len(
    row: &ConfigRowView,
    target_path: &[PathSegment],
) -> Option<usize> {
    std::iter::once(&row.primary_path)
...
pub(in crate::app) fn move_selected_config_section(
...
pub(in crate::app) fn move_selected_bottom_panel_row(
    dialog: &mut PluginWorkbenchOverlay,
    delta: isize,
) {
...
pub(in crate::app) fn select_config_path(
    dialog: &mut PluginWorkbenchOverlay,
    plugin_id: &str,
    path: &[PathSegment],
) {
...
pub(in crate::app) fn row_visible(_row: &ConfigRowView, _view: PluginConfigView) -> bool {
    true
}

pub(in crate::app) fn row_rename_action_allowed(
    plugin: &PluginWorkbenchPlugin,
    path: &[PathSegment],
) -> bool {
...
pub(in crate::app) fn array_item_primary_action(
...
pub(in crate::app) fn config_row_primary_action(
    plugin: &PluginWorkbenchPlugin,
...
pub(in crate::app) fn config_row_action_display(
    plugin: &PluginWorkbenchPlugin,
    editor: &ConfigRowEditor,
    primary_path: &[PathSegment],
    additional_paths: &[ConfigPath],
...
pub(in crate::app) fn config_row_cell_fallback_order(
...
pub(in crate::app) fn normalize_config_row_cell(
    row: &ConfigRowView,
    layout: ConfigGroupLayout,
    preferred: ConfigRowCell,
) -> ConfigRowCell {
...
pub(in crate::app) fn move_config_row_cell(
    row: &ConfigRowView,
    layout: ConfigGroupLayout,
...
pub(in crate::app) fn config_row_cell_label(
    row: &ConfigRowView,
    layout: ConfigGroupLayout,
    cell: ConfigRowCell,
) -> &'static str {
...
pub(in crate::app) fn group_has_action_column(
...
pub(in crate::app) fn section_selected_row_cell(
    section: &ConfigSectionView,
    view: PluginConfigView,
    index: usize,
    preferred: ConfigRowCell,
...
pub(in crate::app) fn drilldown_selected_row_cell(
    overlay: &PluginConfigDrilldownOverlay,
    view: PluginConfigView,
    preferred: ConfigRowCell,
) -> ConfigRowCell {
...
pub(in crate::app) fn drilldown_selected_row_cell_for_groups(
...
#[derive(Debug, Clone)]
pub(in crate::app) struct SelectedConfigRowContext {
...
pub(in crate::app) fn selected_config_row_context(
...
pub(in crate::app) fn group_row_paths(group: &ConfigGroupView) -> Vec<ConfigPath> {
...
pub(in crate::app) fn section_group_for_row(
    section: &ConfigSectionView,
    view: PluginConfigView,
    index: usize,
...
pub(in crate::app) fn drilldown_group_for_row(
    overlay: &PluginConfigDrilldownOverlay,
    view: PluginConfigView,
    index: usize,
) -> Option<&ConfigGroupView> {
...
pub(in crate::app) fn drilldown_group_for_row_in_groups(
    groups: &[ConfigGroupView],
    view: PluginConfigView,
    index: usize,
) -> Option<&ConfigGroupView> {
...
pub(in crate::app) fn build_drilldown_groups(
    plugin: &PluginWorkbenchPlugin,
    path: &ConfigPath,
    title: &str,
) -> Vec<ConfigGroupView> {
...
pub(in crate::app) fn drilldown_row_count(
    overlay: &PluginConfigDrilldownOverlay,
    view: PluginConfigView,
) -> usize {
    overlay
...
pub(in crate::app) fn drilldown_row_at(
    overlay: &PluginConfigDrilldownOverlay,
    view: PluginConfigView,
    index: usize,
) -> Option<&ConfigRowView> {
...
pub(in crate::app) fn drilldown_row_at_groups(
    groups: &[ConfigGroupView],
    view: PluginConfigView,
    index: usize,
) -> Option<&ConfigRowView> {
...
pub(in crate::app) fn rebuild_drilldown_overlay(
    dialog: &PluginWorkbenchOverlay,
...
pub(in crate::app) fn rebuild_drilldown_stack(
    dialog: &PluginWorkbenchOverlay,
