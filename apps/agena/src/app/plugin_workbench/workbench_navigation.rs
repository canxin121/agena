impl App {
    ...
    pub(in crate::app) fn append_config_array_item(
        &mut self,
        dialog: &mut PluginWorkbenchOverlay,
        plugin_id: &str,
        path: &[PathSegment],
    ...
    pub(in crate::app) fn move_selected_main_config_cell(
        &mut self,
        dialog: &mut PluginWorkbenchOverlay,
        delta: isize,
    ) -> bool {
    ...
    pub(in crate::app) fn move_selected_drilldown_cell(
        &mut self,
        dialog: &mut PluginWorkbenchOverlay,
        delta: isize,
    ) -> bool {
    ...
    pub(in crate::app) fn open_config_type_selector(
        &mut self,
        dialog: &mut PluginWorkbenchOverlay,
    ) {
    ...
    pub(in crate::app) fn maybe_open_type_selector_for_selected_row(
        &mut self,
        dialog: &mut PluginWorkbenchOverlay,
        plugin_id: &str,
        path: &[PathSegment],
    ...
    pub(in crate::app) fn open_type_selector_for_row(
        &mut self,
        dialog: &mut PluginWorkbenchOverlay,
        plugin_id: String,
        row: ConfigRowView,
    ...
    pub(in crate::app) fn open_selected_config_value_editor(
        &mut self,
        dialog: &mut PluginWorkbenchOverlay,
    ) {
        let Some(context) = selected_config_row_context(dialog) else {
    ...
    pub(in crate::app) fn open_drilldown_selected_row_editor(
        &mut self,
        dialog: &mut PluginWorkbenchOverlay,
    ) {
    ...
    pub(in crate::app) fn open_row_cell_editor(
        &mut self,
        dialog: &mut PluginWorkbenchOverlay,
        plugin_id: String,
        row: ConfigRowView,
    ...
    pub(in crate::app) fn open_nullable_string_value_editor(
        &mut self,
        dialog: &mut PluginWorkbenchOverlay,
        plugin_id: String,
        row: ConfigRowView,
    ...
    pub(in crate::app) fn open_pair_integer_value_editor(
        &mut self,
        dialog: &mut PluginWorkbenchOverlay,
        plugin_id: String,
        row: ConfigRowView,
    ...
    pub(in crate::app) fn open_row_editor(
        &mut self,
        dialog: &mut PluginWorkbenchOverlay,
        plugin_id: String,
        row: ConfigRowView,
    ...
    pub(in crate::app) fn set_config_value_at(
        &mut self,
        dialog: &mut PluginWorkbenchOverlay,
        plugin_id: String,
        path: ConfigPath,
    ...
    pub(in crate::app) fn try_set_config_values_at(
        &mut self,
        dialog: &mut PluginWorkbenchOverlay,
        plugin_id: String,
    ...
    pub(in crate::app) fn try_set_config_value_at(
        &mut self,
        dialog: &mut PluginWorkbenchOverlay,
        plugin_id: String,
        path: ConfigPath,
    ...
    pub(in crate::app) fn open_named_selection_overlay(
        &mut self,
        dialog: &mut PluginWorkbenchOverlay,
        title: String,
        prompt: String,
    ...
    pub(in crate::app) fn open_branch_selection_overlay(
        &mut self,
        dialog: &mut PluginWorkbenchOverlay,
        title: String,
        prompt: String,
    ...
    pub(in crate::app) fn open_enum_selection_overlay(
        &mut self,
        dialog: &mut PluginWorkbenchOverlay,
        title: String,
        plugin_id: String,
    ...
    pub(in crate::app) fn open_multi_enum_selection_overlay(
        &mut self,
        dialog: &mut PluginWorkbenchOverlay,
        title: String,
        plugin_id: String,
    ...
    pub(in crate::app) fn open_structured_row_drilldown(
        &mut self,
        dialog: &mut PluginWorkbenchOverlay,
        plugin_id: String,
        path: ConfigPath,
    ...
    pub(in crate::app) fn delete_drilldown_selected_row(
        &mut self,
        dialog: &mut PluginWorkbenchOverlay,
    ) {
