                ...
                .map(|session| {
                    vec![
                        ...
                        i18n.text_args(
                            ...
                            &agena_tui::fl_args!("url" => session.display_authorize_url().to_owned()),
                        ),
                        i18n.text_args(
                ...
                .map(|device| {
                    vec![
                        i18n.text_args(
                            ...
                            &agena_tui::fl_args!("code" => device.user_code.clone()),
                        ),
                        i18n.text_args(
                            "provider-studio-auth-verify",
                            &agena_tui::fl_args!("url" => device.display_verification_url().to_owned()),
                        ),
                        i18n.text_args(
