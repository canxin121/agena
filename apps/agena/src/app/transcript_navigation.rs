...
impl TranscriptNodeKind {
    pub(in crate::app) fn uses_atomic_navigation(self) -> bool {
        matches!(
            self,
...
impl RenderedTranscriptNode {
    pub(in crate::app) fn contributes_to_aggregate_copy(&self) -> bool {
...
pub(in crate::app) fn transcript_semantic_line_range(
    lines: &[RenderedLine],
...
use crate::app::{I18n, RenderedLine, TranscriptMoveDirection, ui_text};
