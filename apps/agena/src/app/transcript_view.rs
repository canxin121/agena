...
pub(in crate::app) fn style_for_role(role: agena_api::resource::MessageRole) -> Style {
    match role {
...
mod tests {
    ...
    fn operation_resource(
        part: &crate::app::MessagePartResource,
    ) -> &crate::app::OperationPartResource {
        match part.content.as_ref() {
            Some(crate::app::MessagePartDetailResource::Operation(operation)) => operation,
    ...
    fn tool_api_calls_show_the_model_action_and_execution_tool() {
        ...
        let invocation = crate::app::ToolInvocationResource {
