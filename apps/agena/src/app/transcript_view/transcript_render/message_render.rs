...
pub(in crate::app) fn is_activity_part(part: &MessagePartResource) -> bool {
    matches!(
...
pub(in crate::app) fn activity_part_copy_text(
    part: &MessagePartResource,
    i18n: &I18n,
) -> Option<String> {
...
pub(in crate::app) fn thinking_collapsed_summary(
