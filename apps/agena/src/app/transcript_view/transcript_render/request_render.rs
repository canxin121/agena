...
use crate::app::{MessagePartDetailResource, MessagePartResource, MessageRequestPartResource};
...
pub(in crate::app) fn preview_for_part(part: &MessagePartResource, i18n: &I18n) -> Option<String> {
