...
use crate::app::{MessagePartDetailResource, MessagePartResource};
use crate::app::{OperationBlockResource, OperationPartResource};
use unicode_segmentation::UnicodeSegmentation;

pub(in crate::app) fn transcript_message_parts(
...
pub(in crate::app) fn transcript_part_content(
...
pub(in crate::app) fn operation_block_copy_text(
    block: &OperationBlockResource,
    i18n: &I18n,
) -> String {
    match block {
...
pub(in crate::app) fn tool_display_label(tool: &OperationPartResource) -> String {
...
pub(in crate::app) fn operation_text_block_text(block: &OperationBlockResource) -> Option<&str> {
    match block {
