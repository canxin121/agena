...
impl From<agena_provider::CredentialIssuer> for AuthCredentialIssuerResource {
    fn from(value: agena_provider::CredentialIssuer) -> Self {
        match value {
            agena_provider::CredentialIssuer::OpenaiChatgpt => Self::OpenaiChatgpt,
            agena_provider::CredentialIssuer::GithubCopilot => Self::GithubCopilot,
            agena_provider::CredentialIssuer::Gitlab => Self::Gitlab,
            agena_provider::CredentialIssuer::GoogleAdc => Self::GoogleAdc,
            agena_provider::CredentialIssuer::SapAiCore => Self::SapAiCore,
        }
    }
}
