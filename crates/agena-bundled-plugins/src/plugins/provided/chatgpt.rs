...
#[agena_plugin_host::sdk::agena_plugin(
    ...
    settings_schema = agena_plugin_sdk::macro_support::json_schema_for_default(ChatGptToolsConfig::default()),
)]
impl ChatGptToolsPlugin {
    #[hook(init)]
