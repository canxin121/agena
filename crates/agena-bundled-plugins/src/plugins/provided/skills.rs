//! `agena.skills` — discovery and reading for bundled, user and workspace
//! Skill packages.
//!
...
//! task. The plugin deliberately owns no session activation state.
...
mod tests {
    ...
    use super::{SkillsPlugin, SkillsRefreshInput};
    ...
    fn manifest_exposes_plain_text_catalog_tools_without_activation_hooks() {
        ...
        let tool_names = manifest
            ...
            .collect::<Vec<_>>();
        assert_eq!(tool_names, ["list", "get", "read_resource", "refresh"]);
