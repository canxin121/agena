...
pub fn append_constraint_path_suffix(path: &LitStr, suffix: &str) -> LitStr {
...
pub fn resolve_known_constraint_path(
    path: &LitStr,
...
pub fn normalize_array_value_lit_paths(
    paths: &mut [LitStr],
    field_path_lookup: &BTreeMap<String, LitStr>,
    array_field_paths: &BTreeSet<String>,
) {
...
pub fn resolve_constraint_lit_paths(
    paths: &mut [LitStr],
    field_path_lookup: &BTreeMap<String, LitStr>,
) {
    for path in paths {
...
pub fn resolve_constraint_string_paths(
...
pub fn resolve_constraint_usize_paths(
...
pub fn resolve_constraint_expr_paths(
...
pub fn resolve_constraint_values_paths(
...
pub fn resolve_constraint_group_paths(
...
pub fn resolve_constraint_pair_paths(
...
pub fn resolve_constraint_strings_paths(
...
pub fn normalize_array_value_nested_path_constraints(
...
// Keeping each constraint family explicit prevents accidental cross-family mutation.
#[allow(clippy::too_many_arguments)]
pub fn normalize_array_value_constraints(
    trim: &mut [LitStr],
...
pub fn prefixed_constraint_group(
    current: &LitStr,
    peers: &[LitStr],
    field_path_lookup: Option<&BTreeMap<String, LitStr>>,
) -> Vec<LitStr> {
