...
pub use manifest::{
    ...
    ToolDisplayPreset, ToolInput, ToolPermissionContract, ToolResultPolicy, ToolResultRenderKind,
    ToolStreamingMode, ToolTag, TransportKind, UiTextDisplayMode, normalize_tool_tag_name,
