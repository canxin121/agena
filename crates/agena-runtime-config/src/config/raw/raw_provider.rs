use super::Merge;
use super::{
    BTreeMap, ConfigError, CredentialIssuer, HttpProviderAdapterConfig, ProviderAdapterDefinition,
    ProviderApiAuthConfig, ProviderAuthConfig, ProviderKind, ResolvedProviderAdapterConfig,
    ResolvedProviderConfig, merge_option, normalize_optional, required_string,
...
use agena_provider::{
    ...
    ProviderOverlay, ProviderProtocolPathsConfig, ProviderProtocolPathsOverlay,
...
fn resolve_adapter_config(
    ...
    let definition = match kind {
        ProviderKind::Ollama => ProviderAdapterDefinition::Ollama(crate::OllamaProviderOptions {
        ...
        ProviderKind::OpenAiResponses => {
            ...
            ProviderAdapterDefinition::OpenAiResponses(HttpProviderAdapterConfig {
                ...
                extra_headers,
                options: crate::OpenAiResponsesProviderOptions {
                    backend,
        ...
        ProviderKind::Anthropic => {
            ...
            ProviderAdapterDefinition::Anthropic(HttpProviderAdapterConfig {
                user_agent: normalize_optional(user_agent),
                extra_headers,
                options: crate::AnthropicProviderOptions {
                    models_url: normalize_optional(models_url),
        ...
        ProviderKind::Gemini => {
            ...
            ProviderAdapterDefinition::Gemini(HttpProviderAdapterConfig {
                user_agent: normalize_optional(user_agent),
                extra_headers,
                options: crate::GeminiProviderOptions {
        ...
        ProviderKind::Gitlab => ProviderAdapterDefinition::Gitlab(crate::GitlabProviderOptions {
        ...
        ProviderKind::AmazonBedrock => {
            ProviderAdapterDefinition::AmazonBedrock(crate::AmazonBedrockProviderOptions)
        }
    };
