...
pub fn without_legacy_tool_protocol_prompt(prompt: &str) -> &str {
    prompt
...
pub fn allowed_tools(profile: &AgentProfile) -> Vec<String> {
    ...
    vec![
        default_profile(
            ...
            default_permission(
                ...
                agena_domain::PermissionMode::Ask,
                &[
                    ("interactive", agena_domain::PermissionMode::Allow),
                    ("planning", agena_domain::PermissionMode::Allow),
                    ("task", agena_domain::PermissionMode::Allow),
                    ("discovery", agena_domain::PermissionMode::Allow),
                    ("goal", agena_domain::PermissionMode::Allow),
                ],
            ),
        ...
        default_profile(
            ...
            default_permission(
                ...
                agena_domain::PermissionMode::Ask,
                &[
                    ("read_only", agena_domain::PermissionMode::Allow),
                    ("filesystem_read", agena_domain::PermissionMode::Allow),
                    ("network", agena_domain::PermissionMode::Allow),
                    ("internet", agena_domain::PermissionMode::Allow),
                    ("discovery", agena_domain::PermissionMode::Allow),
                    ("interactive", agena_domain::PermissionMode::Allow),
                    ("shell", agena_domain::PermissionMode::Ask),
                ],
            ),
    ...
    fn read_only_profile_permissions_use_real_tool_tags() {
        ...
        assert!(matches!(
            agent.authorize_tool(
                ...
                None,
                &[
                    agena_plugin_host::sdk::ToolTag::ReadOnly,
                    agena_plugin_host::sdk::ToolTag::Internet,
                ],
            ),
