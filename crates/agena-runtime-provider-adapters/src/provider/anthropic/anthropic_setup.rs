use super::{
    AnthropicAdapter, AnthropicAdapterOptions, AnthropicProfile, AuthData,
    DEFAULT_ANTHROPIC_BETA_HEADER, DEFAULT_COPILOT_ANTHROPIC_BETA_HEADER, DEFAULT_COPILOT_BASE_URL,
    HashMap, ManagedCredential, ModelId, ProviderError, normalize_domain, utils,
};
...
impl AnthropicAdapter {
    ...
    pub(crate) fn resolved_base_url(&self) -> Result<String, ProviderError> {
    ...
    pub(crate) fn models_endpoint(&self) -> Result<String, ProviderError> {
    ...
    pub(crate) fn messages_endpoint(&self) -> Result<String, ProviderError> {
