...
pub(super) fn skill() -> Skill {
    Skill::bundled(
        SkillFrontmatter {
            ...
            description: "Generate or edit images with ordinary OpenAI execution tools".to_owned(),
            aliases: vec!["image-generate".to_owned(), "image-edit".to_owned()],
            allowed_tools: vec![
                "agena.openai.image_generation".to_owned(),
                "agena.openai.image_edit".to_owned(),
