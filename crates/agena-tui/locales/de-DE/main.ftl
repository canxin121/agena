...
permission-studio-command-rules-shell-only = Befehlsregeln gelten nur für Shell-Tools (Shell / Bash / Agena.shell.run / Agena.process.run); Verwenden Sie eine Namensregel oder die Standardeinstellung für andere Tools.
