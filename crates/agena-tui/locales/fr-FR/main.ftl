...
permission-studio-command-rules-shell-only = Les règles de commande s'appliquent uniquement aux outils shell (shell / bash / agena.shell.run / agena.process.run) ; utilisez une règle de nom ou la règle par défaut pour d'autres outils.
