            ...
            vec![
                (
                    ...
                    vec![
                        ...
                        ("0 / ^ / $", "context-help-key-line-start-end"),
                        ("Home / End", "context-help-key-line-start-end"),
                        ("w / b / e / ge", "context-help-key-word"),
                        ("W / B / E / gE", "context-help-key-word"),
                        ("f / F / t / T", "context-help-key-find"),
                        ("; / ,", "context-help-key-find"),
                        ("Ctrl+K / Ctrl+J", "context-help-key-transcript-horizontal"),
                        ("[count] + motion", "context-help-key-count"),
                        ("1–9 / 0", "context-help-key-count-prefix"),
                        ("Space / Ctrl+B / Ctrl+F", "context-help-key-page"),
                        ("Shift+Space", "context-help-key-page"),
                        ("PageUp / PageDown", "context-help-key-page"),
                        ("Ctrl+U / Ctrl+D", "context-help-key-half-page"),
                        ("Ctrl+E / Ctrl+Y", "context-help-key-scroll-line"),
                        ("Ctrl+O / Ctrl+I", "context-help-key-jump-history"),
                        ("gg / G", "context-help-key-first-last"),
                        ("H / M / L", "context-help-key-viewport"),
                        ("zt / zz / zb", "context-help-key-scroll-viewport"),
                    ],
                ),
                (
                    actions,
