...
use super::{
    AgenaCli, AppError, ApplyPatchExecution, BTreeMap, CompletionArgs, ConfigOutputFormat,
    DateTime, DebugSessionOutput, HashSet, Path, PathBuf, PluginLogsOutput, PluginValidateOutput,
    PluginValidationMessage, PluginValidationMessages, Serialize, Utc, fs,
};
...
pub(super) fn render_serialized<T>(
