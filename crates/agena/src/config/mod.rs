...
pub use overlay::{
    ...
    ProviderNativeToolsOverlay, ProviderOverlay, ProviderProtocolPathsOverlay,
    ProviderSecretSourceOverlay, provider_model_overlay_from_catalog_definition,
...
pub use types::{
    ...
    BedrockSigv4AuthConfig, BrowserHarnessConfig, CLINE_API_BASE_URL,
    CLINE_API_OPENAI_PROTOCOL_PATH, ConfigOutputFormat, ConfigResolution, ConfigResolutionMeta,
    ConfigSource, EditorHarnessConfig, GeminiProviderOptions, GitlabProviderOptions,
    HarnessViewportConfig, HarnessesConfig, HostedCodeExecutionContainerConfig,
    HttpProviderAdapterConfig, NativeToolFreshness, NativeToolHarnessKind,
    NativeToolUserLocationConfig, OllamaProviderOptions, OpenAiApiModeConfig, OpenAiBackendConfig,
    OpenAiProviderOptions, PluginConfig, ProviderAdapterDefinition, ProviderApiAuthConfig,
    ProviderAuthConfig, ProviderCapabilityFamilyConfig, ProviderClientVersionSettings,
    ProviderCredentialAuthConfig, ProviderDefaultsConfig, ProviderGitlabApiAccessConfig,
    ProviderGitlabAuthConfig, ProviderGitlabCredentialAuthConfig,
    ...
    ProviderHostedWebSearchConfig, ProviderHttpConfig, ProviderHttpCredentialAuthConfig,
    ProviderInlineCredentialAuthConfig, ProviderModelDiscoveryConfig,
    ProviderNativeConnectorConfig, ProviderNativeHarnessBindings, ProviderNativeHarnessRef,
    ProviderNativeToolBinding, ProviderNativeToolKind, ProviderNativeToolRoute,
    ProviderNativeToolRoutesConfig, ProviderNativeToolsConfig, ProviderProtocolPathsConfig,
    ProviderSapAiCoreCredentialAuthConfig, ProviderSecretSourceConfig, RequestRetryConfig,
