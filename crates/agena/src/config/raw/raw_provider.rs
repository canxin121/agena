...
use super::{
    ...
    ProviderSecretSourceConfig, ProviderSecretSourceOverlay, ResolvedProviderAdapterConfig,
...
impl ProviderOverlay {
    pub(super) fn merge_project_from(&mut self, overlay: Self) {
...
fn resolve_adapter_config(
    ...
    let definition = match kind {
        ProviderKind::Ollama => {
            ProviderAdapterDefinition::Ollama(crate::config::OllamaProviderOptions {
        ...
        ProviderKind::Gitlab => {
            ProviderAdapterDefinition::Gitlab(crate::config::GitlabProviderOptions {
        ...
        ProviderKind::AmazonBedrock => {
            ProviderAdapterDefinition::AmazonBedrock(crate::config::AmazonBedrockProviderOptions)
        }
    };
