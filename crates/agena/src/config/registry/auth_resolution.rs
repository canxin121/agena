...
use crate::{
    config::types::{
        CLINE_API_BASE_URL, ProviderCapabilityFamilyConfig, ProviderProtocolPathsConfig,
    },
    provider::{
        AuthRefreshStrategy, AuthSecretSelector, GitlabProviderConfig, ManagedCredential,
...
use super::{
    ...
    ProviderCredentialAuthConfig, parse_sap_ai_core_service_key,
};
...
pub(crate) fn gitlab_instance_url(config: &crate::config::ProviderGitlabAuthConfig) -> String {
    config
        .instance_url
        .clone()
...
pub(crate) fn gitlab_ai_gateway_url(config: &crate::config::ProviderGitlabAuthConfig) -> String {
    config
        .ai_gateway_url
        .clone()
...
pub(crate) fn gitlab_proxy_base_url(
    config: &crate::config::ProviderGitlabAuthConfig,
