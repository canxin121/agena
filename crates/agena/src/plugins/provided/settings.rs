...
impl SettingsPlugin {
    ...
    #[tool(
        ...
        capabilities(crate::plugin::sdk::HostCapability::ReadConfig),
...
mod tests {
    ...
    use crate::permission::{PermissionDecision, PermissionMode, ToolPermissionPolicy};
    use crate::plugin::sdk::{HostCapability, PathKind, Plugin};
    use serde_json::json;
    ...
    fn settings_tags_and_exact_names_use_the_existing_tool_policy() {
        ...
        let policy = config
            .apply_to_tool_permission_policy(ToolPermissionPolicy::new(PermissionMode::Ask))
