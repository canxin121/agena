...
mod tests {
    ...
    #[test]
    fn bedrock_anthropic_request_uses_structured_tools() {
        ...
        assert_eq!(
            body.tools.expect("tools should be present")[0].name,
            crate::tool::model_safe_tool_name("streaming-fixture.stream_fixture.count")
        );
    }

    #[test]
    fn bedrock_wire_tool_name_aliases_dotted_names() {
        assert_eq!(
            bedrock_wire_tool_name("streaming-fixture.stream_fixture.count"),
            crate::tool::model_safe_tool_name("streaming-fixture.stream_fixture.count")
        );
    }

    #[test]
    fn bedrock_anthropic_completion_parses_structured_tool_calls() {
        ...
        let payload = BedrockAnthropicMessagesResponse {
            ...
            content: vec![BedrockAnthropicTextBlock::tool_use(
                "call_1".to_owned(),
                crate::tool::model_safe_tool_name("a.b.c"),
                "{\"x\":1}".to_owned(),
            )],
            usage: None,
        };
