...
impl AmazonBedrockAdapter {
    ...
    pub(super) fn prompt_cache_sigv4_env_shape() -> Option<crate::provider::PromptCacheShape> {
    ...
    pub(super) fn parse_models(&self, payload: Value) -> Result<Vec<ProviderModel>, AppError> {
