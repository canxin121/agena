use super::{
    ...
    ExecutionStatus, FinishReason, HistoryMessageId, Message, MessageIdAllocator,
    MessageProviderState, ToolCallId, ToolInvocation,
};
...
#[derive(Debug, Default, Clone)]
pub(crate) struct PendingNativeToolCall {
    pub(crate) part_id: Option<i64>,
    pub(crate) call_id: Option<i64>,
    pub(crate) started_at_ms: Option<i64>,
    pub(crate) id: Option<String>,
