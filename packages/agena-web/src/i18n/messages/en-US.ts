export default {
  ...
  help: {
    dialog: {
      ...
      sections: {
        ...
        transcriptVim: 'Transcript Navigation',
        transcriptSelection: 'Transcript Selection & Copy',
      ...
      shortcuts: {
        ...
        abortActiveRunDouble: 'Clear a draft or interrupt the active run',
        cycleTheme: 'Cycle Theme (Light → Dark → System)',
        openFiles: 'Open Files',
        openTerminal: 'Open Terminal',
        openGitPanel: 'Open Git Panel',
        openSettings: 'Open Settings',
        vimModes: 'Enter INSERT mode / return to transcript navigation',
        vimMotions: 'Move by grapheme or visual line with an optional count',
        vimMessages: 'Jump to the previous / next message',
        vimBounds: 'Jump to the first, numbered, or final transcript node',
        vimViewport: 'Move to or place the cursor at viewport landmarks',
        vimScroll: 'Scroll by half pages, pages, or individual lines',
        vimSearch: 'Search forward / backward and repeat matches',
        vimStructure: 'Expand or collapse the current transcript part',
        vimVisual: 'Start character, line, or block Visual selection',
        vimYank: 'Copy a selection, current node, or counted nodes',
        vimTextObjects: 'Select words, paragraphs, Markdown parts, or complete messages',
        vimWords: 'Move between Unicode words or whitespace-delimited WORDs',
        openPlan: 'Open the current session plan',
        vimReselect: 'Swap the Visual endpoint / restore the last selection',
        vimFind: 'Find a character and repeat the find',
        vimJumps: 'Move backward / forward through the jump list',
      },
    },
  },
  mcp: {
  ...
  settings: {
    ...
    tui: {
      ...
      clientVersionsDescription: 'Pin or refresh the installed client versions used by provider integrations.',
      refreshing: 'Refreshing…',
      ...
      fields: {
        locale: 'Locale',
        localeDescription: 'Language used by the runtime and TUI.',
        colorScheme: 'Color scheme',
        colorSchemeDescription: 'Light, dark, or system color scheme for TUI rendering.',
        graphics: 'Graphics',
        ...
        claudeVersionDescription: 'Version constraint or release selected for the Claude client.',
        geminiVersion: 'Gemini client version',
        geminiVersionDescription: 'Version constraint or release selected for the Gemini client.',
        autoCompaction: 'Automatic compaction',
        autoCompactionDescription: 'Compact the session automatically when the context budget requires it.',
        reservedTokens: 'Reserved tokens',
        reservedTokensDescription: 'Tokens kept available before automatic compaction is triggered.',
        tracingFilter: 'Tracing filter',
        tracingFilterDescription: 'Tracing filter directive used by the runtime.',
        tracingDatabase: 'Tracing database',
        tracingDatabaseDescription: 'Tracing database sink or target.',
        tracingAdapter: 'Tracing adapter',
        tracingAdapterDescription: 'Tracing adapter used to export runtime events.',
      },
    },
    debug: {
      title: 'Debug Tools',
  ...
  chat: {
    planViewer: {
      title: 'Plan',
      session: 'Session {id}',
      requiresSession: 'Open a session before viewing its plan.',
      autorun: 'Autorun',
      noAutorun: 'No active autorun setting',
      refresh: 'Refresh plan',
      loading: 'Loading plan',
      empty: 'No plan is available for this session.',
    },
    toasts: {
    ...
    commandPalette: {
      ...
      builtIns: {
        ...
        settings: 'Open Agena settings',
        model: 'Choose the model for this session',
        review: 'Ask the review skill to inspect changes',
        commit: 'Create a git commit',
        pr: 'Create a pull request',
        export: 'Export the loaded transcript',
        pager: 'Page through the transcript',
        continue: 'Continue an interrupted or waiting session',
        compact: 'Compact the current session context',
        'user-input': 'Open the pending user-input request',
        allow: 'Allow the pending permission once',
        'allow-always': 'Always allow the pending permission',
        deny: 'Reject the pending permission once',
        'deny-always': 'Always reject the pending permission',
        attach: 'Attach a local file',
        skill: 'Open the skill picker',
        'skill-manager': 'Open skill management',
        download: 'Download a workspace file',
        editor: 'Toggle the expanded editor',
        image: 'Attach an image',
        copy: 'Copy the loaded transcript',
        'copy-message': 'Copy the last assistant message',
        'copy-visible': 'Copy the visible transcript',
        fork: 'Fork the current session',
        children: 'Open child sessions',
        parent: 'Open the parent session',
        diagnostics: 'Show session diagnostics',
        status: 'Show the current session status',
        usage: 'Open usage analytics',
        activities: 'Open background activities',
        background: 'Open background activities',
        plan: 'Open the current plan',
        side: 'Open a side conversation fork',
      },
    },
    ...
    sidebar: {
      ...
      directoriesList: {
        ...
        activity: {
          ...
          mixed: 'Running + attention',
          runningTooltip: 'This directory has running sessions',
          attentionTooltip: 'This directory has sessions needing attention',
          mixedTooltip: 'This directory has running and attention sessions',
        },
