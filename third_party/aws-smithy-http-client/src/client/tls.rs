...
///
/// Mozilla/WebPKI bundled root certificates are enabled by default. To start with a clean
/// trust store use [TrustStore::empty].
#[derive(Debug, Clone)]
...
impl TrustStore {
    ...
    /// Enable or disable using the bundled Mozilla/WebPKI trusted root certificate store
    ///
    /// Default: true
