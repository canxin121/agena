...
pub trait BitStore: 'static + Debug {
	...
	/// All implementors are required to have an alignment no stricter than
	/// their size. This accommodates ABIs such as m68k Linux where a wider
	/// integer can have a smaller natural alignment.
	///
