...
#[cfg(all(any(target_arch = "aarch64", target_arch = "x86_64"), target_pointer_width = "32"))]
type mem_blocks_t = u64;
#[cfg(not(all(any(target_arch = "aarch64", target_arch = "x86_64"), target_pointer_width = "32")))]
