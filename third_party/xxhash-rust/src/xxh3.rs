...
#[cfg(all(any(target_feature = "sse2", all(target_arch = "aarch64", target_feature = "neon"), all(target_family = "wasm", target_feature = "simd128")), not(any(target_feature = "avx2", target_feature = "avx512f"))))]
#[repr(align(16))]
#[derive(Clone)]
...
#[derive(Clone)]
struct Acc([u64; ACC_NB]);
#[cfg(not(any(target_feature = "avx512f", target_feature = "avx2", all(target_arch = "aarch64", target_feature = "neon"), all(target_family = "wasm", target_feature = "simd128"), target_feature = "sse2")))]
#[repr(align(8))]
#[derive(Clone)]
struct Acc([u64; ACC_NB]);
...
#[cfg(not(any(target_feature = "avx512f", target_feature = "avx2", target_feature = "sse2", all(target_arch = "aarch64", target_feature = "neon"), all(target_family = "wasm", target_feature = "simd128"))))]
